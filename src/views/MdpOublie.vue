<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 pb-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm flex flex-col justify-center items-center">
      ...
      <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Réinitialisation de mot de passe</h2>
    </div>

    <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        <div>
          <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Envoyer email</label>
          <div class="mt-2">
        ...
        <div class="flex justify-between space-x-4">
          ...
          <button type="submit" class="flex w-1/2 justify-center rounded-md bg-primary-700 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">Réinitialiser</button>
        </div>
      </form>
