<template>
    ...
    <section class="bg-white drop-shadow-lg pt-6 pb-10 rounded-md mb-4">
      <div class="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8 flex flex-col justify-center items-center mb-6">
        ...
        <div v-else class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 mb-6">
          <div v-for="recipe in favoritesRecipes" :key="recipe.title" class="group relative shadow-lg rounded-lg p-4 cursor-pointer">
