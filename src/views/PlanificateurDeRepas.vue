  ...
  <div class="w-full flex justify-center items-center">
    <div class="w-4/5 grid grid-cols-2 gap-8">
      <div class="w-full">
        <!-- Input -->
        <div
          class="w-full flex justify-center items-center flex-col mb-10 px-6 rounded-md py-4 bg-white drop-shadow-lg pt-6 pb-10">
          <div class="w-full mb-8">
            ...
            <div class="mt-10 flex">
              ...
              <button @click="addIngredient"
                class="bg-secondary-100 hover:bg-secondary-200 border border-s-0 border-gray-300 text-primary-700 py-1.5 px-4 rounded-r-md">
                Ajouter
              </button>
            </div>
          </div>
          ...
          <div class="flex flex-wrap gap-4">
            ...
            <div @click="validateIngredients" v-if="ingredients.length > 0"
                ...
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody class="bg-white">
                    <tr v-for="(ingredient, index) in validatedIngredients" :key="index" class="even:bg-gray-50">
                      <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">{{ ingredient
                      }}</td>
