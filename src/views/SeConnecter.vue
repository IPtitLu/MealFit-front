    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 pb-12 lg:px-8 ">
      ...
      <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" @submit.prevent="handleLogin">
          ...
          <div>
            ...
            <div class="flex justify-between space-x-4">
              <RouterLink to="/"
                class="flex w-1/2 justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-gray-700 shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">
                <button type="button">Retour</button>
              </RouterLink>
              <button type="submit"
                class="flex w-1/2 justify-center rounded-md bg-primary-700 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">
                Connexion
              </button>
            </div>
          </div>
        ...
        <p class="mt-10 text-center text-sm">
          <RouterLink to="/inscription" class="font-semibold leading-6 text-primary-700 hover:text-primary-400">S'inscrire
          </RouterLink>
        </p>
      </div>
    </div>
