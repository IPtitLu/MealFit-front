<template>
    ...
    <section class="bg-white drop-shadow-lg pt-6 pb-10 rounded-md mb-4">
      <div class="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8 flex flex-col justify-center items-center">
        ...
        <div v-if="recipes.length < 1 && user != null" class="text-center mb-10">Aucune recette actuellement</div>
        <div v-if="recipes.length < 1 && user == null" class="text-center mb-10">Vous devez être connecté pour voir les recettes en favoris.</div>
